...
const fs = require("fs")
const FRONT_END_ADDRESSES_FILE = "../nextjs-lottery-frontend/constants/contractAddresses.json"
const FRONT_END_ABI_FILE = "../nextjs-lottery-frontend/constants/abi.json"
...
async function updateContractAddresses() {
    ...
    const contractAddresses = JSON.parse(
        fs.readFileSync(FRONT_END_ADDRESSES_FILE, "utf8").toString()
    )
